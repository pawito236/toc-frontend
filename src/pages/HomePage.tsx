...
export const HomePage: React.FC<HomePageProps> = ({ onAnimeClick }) => {
  ...
  const fetchAnimeList = async (page: number) => {
    ...
    try {
      const response: AnimeListResponse = await animeService.getAnimeList(page);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Explore thousands of anime titles, read detailed information, and find your next favorite series.
            </p>
            <div className="flex items-center justify-center gap-2 text-blue-200">
              <TrendingUp className="w-5 h-5" />
              <span>Currently showing {animeList.length} anime on page {currentPage}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <h2 className="text-2xl font-bold text-gray-900">Top Anime</h2>
          ...
          <div className="flex items-center gap-4">
            <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg hover:border-blue-500 transition-colors">
